...
public final class CourseInfo implements Parcelable {
    ...
    private final List<com.example.alayesanmifemi.notekeeperalc.ModuleInfo> mModules;

    public CourseInfo(String courseId, String title, List<com.example.alayesanmifemi.notekeeperalc.ModuleInfo> modules) {
        mCourseId = courseId;
        mTitle = title;
        mModules = modules;
    }
    ...
    private CourseInfo(Parcel source) {
        ...
        source.readTypedList(mModules, com.example.alayesanmifemi.notekeeperalc.ModuleInfo.CREATOR);
    }
    ...
    public List<com.example.alayesanmifemi.notekeeperalc.ModuleInfo> getModules() {
        return mModules;
    }
    ...
    public com.example.alayesanmifemi.notekeeperalc.ModuleInfo getModule(String moduleId) {
        for(com.example.alayesanmifemi.notekeeperalc.ModuleInfo moduleInfo: mModules) {
